...
export const stages: Stage[] = [
  {
    ...
    lessons: [
      ...
      { id: 4, title: "搭建舞台", topic: "背景切换、多角色添加", project: "海底世界" },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 12, title: "小短剧", topic: "综合: 事件+序列+广播", project: "龟兔赛跑动画" },
    ],
  },
  {
    id: 3,
    ...
    lessons: [
      { id: 13, title: "重复的魔法", topic: "重复N次 积木", project: "走正方形" },
      { id: 14, title: "永不停歇", topic: "重复执行 积木", project: "旋转风车" },
      { id: 15, title: "画笔入门", topic: "落笔/抬笔/颜色/粗细", project: "自由涂鸦板" },
      { id: 16, title: "循环画图", topic: "重复+转向=图形", project: "几何图形" },
      { id: 17, title: "走路动画", topic: "造型切换+循环", project: "走路的小人" },
      { id: 18, title: "音乐节拍", topic: "循环+声音", project: "两只老虎演奏" },
      { id: 19, title: "弹弹球", topic: "循环+移动+碰边反弹", project: "弹球屏保" },
      { id: 20, title: "水族箱", topic: "多角色+循环", project: "动态水族箱" },
    ],
  },
  {
    id: 4,
    ...
    lessons: [
      ...
      { id: 24, title: "键盘小达人", topic: "按键侦测+条件", project: "上下左右控制" },
      { id: 25, title: "打地鼠", topic: "随机出现+点击侦测", project: "打地鼠游戏" },
      { id: 26, title: "计分板", topic: "变量(得分)初步", project: "接苹果+计分" },
  ...
  },
  {
    ...
    lessons: [
      { id: 29, title: "魔法特效", topic: "图形特效+循环", project: "特效展示" },
      { id: 30, title: "下雪啦", topic: "克隆基础", project: "下雪动画" },
      { id: 31, title: "满天星", topic: "克隆+随机", project: "粒子效果" },
      { id: 32, title: "我的故事", topic: "自由创作-动画", project: "原创故事动画" },
      { id: 33, title: "我的游戏", topic: "自由创作-游戏", project: "原创小游戏" },
      { id: 34, title: "电子贺卡", topic: "自由创作-应用", project: "节日贺卡" },
      { id: 35, title: "精品打磨", topic: "优化与完善", project: "作品升级" },
      { id: 36, title: "作品展示会", topic: "展示与评价", project: "期末展览" },
    ],
  },
];
